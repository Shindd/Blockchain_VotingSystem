...
(function() {
    ...
    (function() {
        function a(a) {
            ...
            if (f && 0 < f.length || b) {
                ...
                if (!z(ja[A.ckDec(A.obj.sk)]) &&
                    "string" === typeof ja[A.ckDec(A.obj.sk)] && ja[A.ckDec(A.obj.sk)]) { g = ja[A.ckDec(A.obj.sk)]; for (var l = [], k = [], f = 0, m = h = "", p = g.substr(g.length - 3, g.length), n = 0; n < g.length - 3; n++) l.push(parseInt(g.charCodeAt(n)) - 59), h += String.fromCharCode(l[n]), f += parseInt(parseInt(h.charCodeAt(n)) + 59, 10);
                    f %= 256;
                    f = 99 < f ? "" + f : 9 < f ? "0" + f : "00" + f; for (n = 0; n < p.length; n++) k.push(parseInt(p.charCodeAt(n)) - 59), m += String.fromCharCode(k[n]);
                    g = f === m ? h : 0 } else g = 0;
        ...
        A.fSWm = function(c) { if ("undefined" === typeof A.pro.sCH && !Aa) try { if (a(2)) { var b = c[A.fSDec(A.obj.cntx)];
                    b[A.fSDec(A.obj.txtBl)] = A.fSDec(A.obj.tp);
                    b[A.fSDec(A.obj.fnt)] = 11 + A.fSDec(A.obj.fntStr);
                    b[A.fSDec(A.obj.fSy)] = A.fSDec(A.obj.grClr);
                    b[A.fSDec(A.obj.fTx)](A.fSDec(A.obj.trVs), 2, c.height - 11 - 2) } } catch (d) {} };
        A.ckDec = function(a) {
            for (var b =
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var c =
                ...
                for (e = 0; e < n.dataPoints.length; e++) {
                    ...
                    d > b.max && (b.max = d);
                    if (0 < e) {
                        if (a.axisX.logarithmic) { var y = d / n.dataPoints[e - 1].x;
                            1 > y && (y = 1 / y);
                            b.minDiff > y && 1 !== y && (b.minDiff = y) } else y = d - n.dataPoints[e - 1].x, 0 > y && (y *= -1), b.minDiff > y && 0 !== y && (b.minDiff = y);
            ...
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g, l, k = !1, h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                for (p = 0; p < m.dataPoints.length; p++) {
                    ...
                    if ((f = m.dataPoints[p].y) && f.length) { g = Math.min.apply(null, f);
                        ...
                        r = !0; for (var y = 0; y < f.length; y++) null === f.k && (r = !1);
                        r && (n || (s = q), q = d) }
                    d < b.min && (b.min = d);
                    d > b.max && (b.max = d);
                    g < c.min && (c.min = g);
                    ...
                    for (w = !1, r = 0; r < h.length; r++)
                        if (s = h[r].getTime ? h[r].x.getTime() : h[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !w)))
                            if ("number" !== typeof h[r].y) 0 < r && !w && (k.connectNullData ? b.setLineDash && (0 < u.length && (k.options.nullDataLineDashType ||
                                ...
                                if (0 < h[r].markerSize || 0 < k.markerSize) { var x = k.getMarkerProperties(r, s, w, b);
                                    f.push(x);
                                    y = F(y);
                                    t && f.push({ x: s, y: w, ctx: d, type: x.type, size: x.size, color: y, borderColor: y, borderThickness: x.borderThickness }) }(h[r].indexLabel || k.indexLabel || h[r].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "spline",
                                    dataPoint: h[r],
                                    dataSeries: k,
                                    point: { x: s, y: w },
                ...
                if (0 < r.length) {
                    ...
                    for (k = 0; k < r.length; k++)
                        if (b = r[k].x.getTime ? r[k].x.getTime() : r[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[k].y) {
                            ...
                            else if (h = a.axisY.convertValueToPixel(r[k].y), 0 <= r[k].y) { var x = f[b] ? f[b] : 0;
                                h -= x;
                                y = m - x;
                                f[b] = x + (y - h) } else x = g[b] ? g[b] : 0, y = h + x, h = m + x, g[b] = x + (y - h);
                    ...
                    for (var s = 5 < n && q.bevelEnabled ? !0 : !1, k = 0; k < r.length; k++)
                        if (b = r[k].x.getTime ? r[k].x.getTime() : r[k].x, !(b < a.axisX.dataInfo.viewPortMin ||
                            ...
                            if (a.axisY.logarithmic) { l[b] = h + (l[b] ? l[b] : 0); if (0 >= l[b]) continue;
                                ...
                                y = f[b] ? f[b] : m;
                                f[b] = h } else if (h = a.axisY.convertValueToPixel(h), 0 <= r[k].y) { var x = f[b] ? f[b] : 0;
                                h -= x;
                                y = m - x;
                                f[b] = x + (y - h) } else x = g[b] ? g[b] : 0, y = h + x, h = m + x, g[b] = x + (y - h);
                    ...
                    for (k = 0; k < r.length; k++)
                        if (b = r[k].x.getTime ? r[k].x.getTime() : r[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[k].y) {
                            ...
                            if (a.axisY.logarithmic) l[b] = r[k].y + (l[b] ? l[b] : 0), 0 < l[b] && (y = f[b] ? f[b] : m, f[b] = h = a.axisY.convertValueToPixel(l[b]));
                                ...
                                y = m + x;
                                h += x;
                                f[b] = x + (h - y) } else x = g[b] ? g[b] : 0, y = h - x, h = m - x, g[b] = x + (h - y);
                            b = r[k].color ? r[k].color : q._colorSet[k % q._colorSet.length];
    ...
    B.prototype.renderStackedArea = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (g = 0; g < a.dataSeriesIndexes.length; g++) { var x = a.dataSeriesIndexes[g],
                    v = this.data[x],
                    z = v.dataPoints;
                v.dataPointIndexes = []; for (p = 0; p < z.length; p++) x = z[p].x.getTime ? z[p].x.getTime() : z[p].x, v.dataPointIndexes[x] = p, d[x] || (h.push(x), d[x] = !0);
                h.sort(ya) }
            for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if (0 < h.length) {
                    ...
                    y = "solid";
                    if (b.setLineDash) { var C = G(v.nullDataLineDashType, v.lineThickness);
                        y = v.lineDashType; var V = G(y, v.lineThickness);
                        b.setLineDash(V) }
                    for (var W = !0, p = 0; p < h.length; p++) {
                        ...
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!v.connectNullData || !W)))
                            if ("number" !== typeof I.y) v.connectNullData ||
                                ...
                                if (0 <= v.dataPointIndexes[q]) { var ea = v.dataPointIds[v.dataPointIndexes[q]];
    ...
    B.prototype.renderStackedArea100 = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            d = [];
            for (f = 0; f < a.dataSeriesIndexes.length; f++) { var x = a.dataSeriesIndexes[f],
                    v = this.data[x],
                    z = v.dataPoints;
                v.dataPointIndexes = []; for (p = 0; p < z.length; p++) x = z[p].x.getTime ? z[p].x.getTime() : z[p].x, v.dataPointIndexes[x] = p, d[x] || (h.push(x), d[x] = !0);
                h.sort(ya) }
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < h.length) {
                    ...
                    w = "solid";
                    if (b.setLineDash) { var C = G(v.nullDataLineDashType, v.lineThickness);
                        w = v.lineDashType; var V = G(w, v.lineThickness);
                        b.setLineDash(V) }
                    for (var W = !0, p = 0; p < h.length; p++) {
                        q = h[p];
                        var I = null,
                        ...
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax &&
                            ...
                            if ("number" !== typeof I.y) v.connectNullData || (W || s) || c(), W = !0;
                                ...
                                if (0 <= v.dataPointIndexes[q]) { var Fa = v.dataPointIds[v.dataPointIndexes[q]];
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if (0 < m.length) {
                    ...
                    var v = "solid";
                    if (b.setLineDash) { var z = G(h.nullDataLineDashType, h.lineThickness),
                            v = h.lineDashType,
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if (0 < h.length) {
                    ...
                    var y = "solid",
                        x;
                    if (b.setLineDash) { var v = G(k.nullDataLineDashType, k.lineThickness),
                            y = k.lineDashType;
                    ...
                    for (var a = -1, b = -1, c = 0, e = !1, g = 0; g < p.length; g++)
                        if (e = !1, u = q[g], u.indexLabelText) {
                            ...
                            if (null !== h) {
                                ...
                                z = d(u, k);
                                var l;
                                if (l = 0 > z) { l = u.indexLabelTextBlock.x; var m = u.indexLabelTextBlock.y - u.indexLabelTextBlock.height / 2,
                ...
                if ("pie" !== n.type && "doughnut" !== n.type && "funnel" !== n.type) {
                    ...
                    for (var t = 0; t < n.dataPoints.length; t++) {
                        var x = n.dataPoints[t],
                            ...
                            e = { markerType: e, markerColor: r, text: q, textBlock: null, chartType: n.type, markerSize: s, dataSeriesIndex: p, dataPointIndex: t, markerBorderColor: w, markerBorderThickness: u };
                ...
                if (!(0 >= l || "undefined" === typeof l || 0 >= q || "undefined" === typeof q)) {
                    if ("horizontal" === this.orientation) {
                        ...
                        if (!n || n.width + Math.round(e.textBlock.width + s + k + (0 === n.width ? 0 : this.horizontalSpacing) + ("line" === e.chartType || "spline" === e.chartType || "stepLine" ===
                                e.chartType ? 2 * 0.1 * this.lineHeight : 0)) > g) n = { items: [], width: 0 }, m.push(n), this.height += t, t = 0;
                        ...
                        (s + k + ("line" === e.chartType || "spline" === e.chartType || "stepLine" === e.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < l - this.lineHeight ? (n = { items: [], width: 0 }, m.push(n)) : (n = m[x], x = (x + 1) % m.length), this.height += e.textBlock.height;
    ...
    C.prototype.createLabels = function() {
        ...
        if (this.labelAutoFit || this.options.labelAutoFit)
            if (z(this.labelAngle) || (this.labelAngle = (this.labelAngle %
                ...
                if (g = 0.9 * h >> 0, n = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                    ...
                    for (b = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; b < this._labels.length; b++)
                        if (a = this._labels[b].textBlock, q = a.measureText(), b < this._labels.length - 1 && (e = b + 1, c = this._labels[e].textBlock, c = c.measureText()), f.push(a.height), this.sessionVariables.labelMaxHeight = Math.max.apply(Math,
                                f), Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)), Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), d = g * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (l - a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)), z(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                            if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? l : Math.min((d - g * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), d), s = (p - (m + a.fontSize / 2) *
                                ...
                                if (z(this.options.labelWrap))
                                    if (!z(this.options.labelMaxWidth)) this.options.labelMaxWidth < g ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = d) : (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = l);
                                    else if (!z(c))
                                    if (d = q.width + c.width >> 0, e = this.labelFontSize, n < g) d - 2 * g > k && (k = d - 2 * g, d >= 2 * g && d < 2.2 * g ? (this.sessionVariables.labelMaxWidth =
                                        ...
                                        z(this.options.labelFontSize) ? e : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = s) : d > 5 * g && (this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = g, this.sessionVariables.labelFontSize = e, this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelAngle = this.labelAngle));
                    ...
                    for (b = 0; b < this._labels.length; b++) a = this._labels[b].textBlock, a.maxWidth = this.labelMaxWidth = z(this.options.labelMaxWidth) ? this.sessionVariables.labelMaxWidth : this.options.labelMaxWidth, a.fontSize = this.labelFontSize = z(this.options.labelFontSize) ? this.sessionVariables.labelFontSize :
                        this.options.labelFontSize, a.angle = this.labelAngle = z(this.options.labelAngle) ? this.sessionVariables.labelAngle : this.labelAngle, a.wrap = this.labelWrap = z(this.options.labelWrap) ? this.sessionVariables.labelWrap : this.options.labelWrap, a.maxHeight = this.sessionVariables.labelMaxHeight, a.measureText();
        else if ("left" === this._position || "right" === this._position)
            if (g = z(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth, l = "undefined" === typeof this.options.labelWrap || this.labelWrap ?
                ...
                for (b = 0; b < this._labels.length; b++) a = this._labels[b].textBlock, a.maxWidth = this.labelMaxWidth = z(this.options.labelMaxWidth) ?
    ...
    C.setLayoutAndRender = function(a, c, b, d, f, g) {
        ...
        if ("normal" === f) {
            ...
            for (; 4 > q;) {
                ...
                L.push(y);
                if (d && 0 < d.length)
                    for (x = [], e = R = 0; e < d.length; e++) x.push(Math.ceil(d[e] ? d[e].createLabelsAndCalculateWidth() : 0)), R += x[e], Q += d[e] ? d[e].margin : 0;
                ...
                if (b &&
                    ...
                    for (e = 0; e < b.length; e++) D = 10, b[e] && (l = Math.round(a[0] ? a[0].lineCoordinates.x1 : c[0].lineCoordinates.x1), D = b[e]._labels && 0 < b[e]._labels.length ? b[e]._labels[b[e]._labels.length - 1].textBlock.height / 2 : 10, k = Math.round(g.y1 + T + K < Math.max(D, 10) ? Math.max(D, 10) : g.y1 + T + K), h = Math.round(a[0] ? a[0].lineCoordinates.x1 : c[0].lineCoordinates.x1), D = 0 < a.length ? 0 : b[e]._labels && 0 < b[e]._labels.length ? b[e]._labels[0].textBlock.height / 2 : 10, m = Math.round(g.y2 - X - f - D), b[e].lineCoordinates = {
                        ...
                        height: Math.abs(m -
                            k)
                    }, b[e].bounds = { x1: l - (y[e] + N), y1: k, x2: h, y2: m, width: h - l, height: m - k }, b[e].title && (b[e]._titleTextBlock.maxWidth = 0 < b[e].titleMaxWidth && b[e].titleMaxWidth < b[e].lineCoordinates.height ? b[e].titleMaxWidth : b[e].lineCoordinates.height), N += y[e] + b[e].margin);
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++) d[e] && (l = Math.round(a[0] ? a[0].lineCoordinates.x2 : c[0].lineCoordinates.x2), h = Math.round(l), D = d[e]._labels && 0 < d[e]._labels.length ? d[e]._labels[d[e]._labels.length - 1].textBlock.height / 2 : 0, k = Math.round(g.y1 + T + K < Math.max(D,
                        10) ? Math.max(D, 10) : g.y1 + T + K), D = 0 < a.length ? 0 : d[e]._labels && 0 < d[e]._labels.length ? d[e]._labels[0].textBlock.height / 2 : 0, m = Math.round(g.y2 - (X + f + D)), d[e].lineCoordinates = { x1: l + O, y1: k, x2: l + O, y2: m, height: Math.abs(m - k) }, d[e].bounds = { x1: l, y1: k, x2: h + (x[e] + O), y2: m, width: h - l, height: m - k }, d[e].title && (d[e]._titleTextBlock.maxWidth = 0 < d[e].titleMaxWidth && d[e].titleMaxWidth < d[e].lineCoordinates.height ? d[e].titleMaxWidth : d[e].lineCoordinates.height), O += x[e] + d[e].margin);
                if (a && 0 < a.length)
                    for (e = 0; e < a.length; e++) a[e] &&
            ...
            for (; 4 > q;) {
                ...
                L.push(r);
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++) b[e].lineCoordinates = {}, l = Math.round(g.x1 + X + f), h = Math.round(g.x2 - T - K > p.width - 10 ? p.width - 10 : g.x2 - T - K), b[e].labelAutoFit && !z(t) && (0 < !a.length && (l = 0 > b[e].labelAngle ? Math.max(l, t) : 0 === b[e].labelAngle ? Math.max(l, t / 2) : l), 0 < !c.length && (h = 0 <
                ...
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++) d[e].lineCoordinates = {}, l = Math.round(g.x1 + X + f), h = Math.round(g.x2 - T - K > d[e].chart.width - 10 ? d[e].chart.width - 10 : g.x2 - T - K), d[e] && d[e].labelAutoFit && !z(y) && (0 < !a.length &&
                ...
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++) d[e] && 0 < d[e]._labels.length && (m = d[e]._labels[0], k = d[e]._labels[d[e]._labels.length - 1], y = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - k.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)), x = k.textBlock.width *
                ...
                if (b && 0 < b.length)
                    for (e = b.length - 1; 0 <= e; e--) k = Math.round(g.y2), m = Math.round(g.y2 > b[e].chart.height - 10 ? b[e].chart.height - 10 : g.y2), b[e].lineCoordinates.y1 = k - (v[e] + b[e].margin + M), b[e].lineCoordinates.y2 = k - (v[e] + b[e].margin +
                        M), b[e].bounds = { x1: l, y1: k - (v[e] + M + b[e].margin), x2: h, y2: m - (M + b[e].margin), width: h - l, height: v[e] }, b[e].title && (b[e]._titleTextBlock.maxWidth = 0 < b[e].titleMaxWidth && b[e].titleMaxWidth < b[e].lineCoordinates.width ? b[e].titleMaxWidth : b[e].lineCoordinates.width), M += v[e] + b[e].margin;
                if (d && 0 < d.length)
    ...
    C.prototype.calculateAxisParameters = function() {
        if (this.logarithmic) this.calculateLogarithamicAxisParameters();
            ...
            if (z(this.options.viewportMinimum) && !z(this.sessionVariables.newViewportMinimum) && !isNaN(this.sessionVariables.newViewportMinimum)) this.viewportMinimum = this.sessionVariables.newViewportMinimum;
